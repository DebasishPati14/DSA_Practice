...
public class ReverseLinkedListDataRecursive {
    ...
    public static class LinkedList {
        ...
        void reverseListDataRecursive(Node node, int middleFlag) {
            if (node == null) {
                return;
            }
            reverseListDataRecursive(node.next, middleFlag + 1);

            if (middleFlag > size() / 2) {
                System.out.println("Did it go " + leftNode.data + ", " + middleFlag + "" + node.data);
